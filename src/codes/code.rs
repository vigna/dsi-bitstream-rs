...
impl CodeWrite for Code {
    ...
    fn write<E: Endianness, CW: CodesWrite<E> + ?Sized>(
        ...
        Ok(match self {
            ...
            Code::Pi { k } => writer.write_pi(value, *k)?,
...
impl CodeLen for Code {
    ...
    fn len(&self, value: u64) -> usize {
        match self {
            ...
            Code::VByte => bit_len_vbyte(value),
            Code::Zeta { k } => len_zeta(value, *k),
            Code::Pi { k } => len_pi(value, *k),
...
impl<const CODE: usize> CodeLen for ConstCode<CODE> {
    ...
    fn len(&self, value: u64) -> usize {
        match CODE {
            ...
            const_codes::VBYTE => bit_len_vbyte(value),
