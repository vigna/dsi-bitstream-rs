...
pub const fn check_read_table(peek_bits: usize) {
    assert!(peek_bits >= READ_BITS, "BitRead peek word too small for delta code read tables (1 bits required)");
}
