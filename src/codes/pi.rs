...
//!
//! The π code with parameter `k` of a natural number `n` is the concatenation
//! of the [Rice code](super::rice) with parameter `k` of `⌊log₂(n + 1)⌋` and of
...
//! the codewords for `k` ≥ 2 are different.
//!
//! # References
//!
